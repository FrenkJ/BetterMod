...
public class CoalGeneratorMenu extends AbstractContainerMenu {
    ...
    public CoalGeneratorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity = ((CoalGeneratorEntity) entity);
        ...
        this.addSlot(new SlotItemHandler(blockEntity.inventory, 0, 54, 34));
        this.addSlot(new SlotItemHandler(blockEntity.inventory, 1, 104, 34));
